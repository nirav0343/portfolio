...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Nirav Patel - Personal CV Website Template</title>
        ...
        <div class="wrapper">
            <div class="sidebar">
                <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
                    ...
                    <h1 class="mt-2">Nirav Patel</h1>
                    <div class="mb-4" style="height: 22px;">
                        <h4 class="typed-text-output d-inline-block text-body"></h4>
                        <div class="typed-text d-none">PHP Developer, Laravel Developer, Shopify Developer, Core PHP Developer, Next JS Developer, React JS Developer, Codeigniter Developer, WordPress Developer</div>
            ...
            <div class="content">
                ...
                <div class="container bg-white py-5">
                    <div class="row px-3">
                        ...
                        <div class="col-12">
                            <p>A dedicated and skilled multilingual professional with extensive experience, seeking a challenging position to leverage my expertise in developing efficient and scalable web applications. Committed to delivering high- quality code while maintaining the highest standards of professionalism, productivity, and continuous improvement</p>
                            <div class="row">
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Name:</h5> Nirav Patel
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Birthday:</h5> 26 April 1997
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Degree:</h5> Master
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Experience:</h5> 3.5 Years
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Phone:</h5> +91 8155948737
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Email:</h5> nirav0343@gmail.com
                                </div>
                                <div class="col-sm-6 py-1">
                                    <h5 class="d-inline text-primary">Address:</h5> Ahmedabad
                                </div>
                                <div class="col-sm-6 py-1">
                        ...
                        <div class="col-12">
                            <div class="border-left border-primary pt-2 pl-4 ml-2">
                                <div class="position-relative mb-4">
                                    ...
                                    <p class="mb-2">Solvios Technology | <small>2021 - Present</small></p>
                                    <p>Developed an e-commerce site focused on providing a marketplace for mindful and sustainable products. Utilized Magento 2 to ensure a robust, scalable, and feature-rich online shopping experience.</p>
                                    <p>Created a dynamic web application with a Next JS frontend, integrated with Laravel APIs for backend functionalities. This setup ensures a seamless and responsive user experience with efficient data handling.</p>
                                    <p>Developed a CRM platform using Next JS for a modern and interactive user interface, with WordPress managing backend functionalities and content management.</p>
                                    <p>Designed and implemented an Le Atelier Paris e- commerce site for a fashion brand using Shopify. Focused on delivering a visually appealing and user-friendly shopping experience.</p>
                                    <p>Developed a website using WordPress, focusing on delivering content related to optimization strategies and solutions, with a user-friendly interface and optimized performance.</p>
                                </div>
                                <div class="position-relative mb-4">
                                    <i class="fa fa-arrow-right text-primary position-absolute" style="top: 3px; left: -24px;"></i>
                                    <h5 class="mb-1">Codeigniter Developer</h5>
                                    <p class="mb-2">Soft Company | <small>01/2021 - 07/2021</small></p>
                                    <p>I developed a family Directory feature using CodeIgniter, where users can view and manage family details. This involved creating a user-friendly interface to display family information and member details, with functionalities to add, update, and delete records.</p>
                                </div>
                                <!-- <div class="position-relative mb-4">
                                    <i class="fa fa-arrow-right text-primary position-absolute" style="top: 3px; left: -24px;"></i>
